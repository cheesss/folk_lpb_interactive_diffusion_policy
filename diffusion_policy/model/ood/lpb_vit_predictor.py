...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        q, k, v = map(lambda y: rearrange(y, "b n (h d) -> b h n d", h=self.heads), qkv)
...
class LPBViTPredictor(nn.Module):
    def __init__(
        self,
        *,
        num_patches,
    ...
    def forward(self, x):
        ...
        return torch.cat([visual_pred, proprio_pred, action_pred], dim=-1)
